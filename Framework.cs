...
namespace Tokyo
{
    ...
    public class Tokyo_ThemeContainer : ContainerControl
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(new SolidBrush(Color.FromArgb(240, 240, 240)), RoundRectangle.RoundRect(new Rectangle(2, 20, Width - 5, Height - 42), BorderCurve));
    ...
    public class Tokyo_ControlBox : Control
    {
    ...
    class Tokyo_Toggle : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            checked
            {
                ...
                G.SmoothingMode = SmoothingMode.AntiAlias;
                G.FillPath(Gradient, (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new Tokyo_Toggle.PillStyle
                {
                    Left = true,
                    Right = true
                }));
                G.DrawPath(new Pen(Color.FromArgb(177, 177, 176)), (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new Tokyo_Toggle.PillStyle
                {
                    Left = true,
                    Right = true
                }));
    ...
    class Tokyo_LinkLabel : LinkLabel
    {

        public Tokyo_LinkLabel()
        {
            Font = new Font("Segoe UI", 8, FontStyle.Regular);
            BackColor = Color.Transparent;
    ...
    class Tokyo_HeaderLabel : Label
    {

        public Tokyo_HeaderLabel()
        {
    ...
    class Tokyo_TextBox_Big : Control
    {
        #region Variables

        public TextBox TokyoTB = new TextBox();
        private GraphicsPath Shape;
        ...
        public bool UseSystemPasswordChar
        {
            ...
            set
            {
                TokyoTB.UseSystemPasswordChar = UseSystemPasswordChar;
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (TokyoTB != null)
                {
                    TokyoTB.Multiline = value;

                    if (value)
                    {
                        TokyoTB.Height = Height - 23;
                    }
                    else
                    {
                        Height = TokyoTB.Height + 23;
                    }
                }
        ...
        public Image Image
        {
            ...
            set
            {
                ...
                if (Image == null)
                {
                    TokyoTB.Location = new Point(8, 10);
                }
                else
                {
                    TokyoTB.Location = new Point(35, 11);
                }
                Invalidate();
            }
        }
        ...
        public void AddTextBox()
        {
            ...
            _TB.Multiline = false;
            TokyoTB.KeyDown += _OnKeyDown;
            TokyoTB.TextChanged += OnBaseTextChanged;
        }

        public Tokyo_TextBox_Big()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);

            AddTextBox();
            Controls.Add(TokyoTB);
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (Image == null)
            {
                TokyoTB.Width = Width - 18;
            }
            else
            {
                TokyoTB.Width = Width - 45;
            }

            TokyoTB.TextAlign = TextAlignment;
            TokyoTB.UseSystemPasswordChar = UseSystemPasswordChar;
    ...
    [DefaultEvent("TextChanged")]
    class Tokyo_TextBox_Small : Control
    {
        #region Variables
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (TokyoTB != null)
                {
                    ...
                    if (value)
                    {
                        TokyoTB.Height = Height - 10;
                    }
                    else
                    {
                        Height = TokyoTB.Height + 10;
                    }
                }
            }
        }
    ...
    [DefaultEvent("TextChanged")]
    class Tokyo_RichTextBox : Control
    {

        #region Variables

        public RichTextBox TokyoRTB = new RichTextBox();
        private bool _ReadOnly;
        ...
        public bool AutoWordSelection
        {
            ...
            set
            {
                ...
                if (TokyoRTB != null)
                {
                    TokyoRTB.AutoWordSelection = value;
                }
            }
        }
        #endregion
        ...
        {
            base.OnSizeChanged(e);
            TokyoRTB.Size = new Size(Width - 13, Height - 11);
        }
    ...
    public class Tokyo_NumericUpDown : Control
    {
    ...
    public class Tokyo_ChatBubble_L : Control
    {
    ...
    public class Tokyo_ChatBubble_R : Control
    {
    ...
    public class Tokyo_Separator : Control
    {

        public Tokyo_Separator()
        {
    ...
    class Tokyo_Panel : ContainerControl
    {
    ...
    public class Tokyo_GroupBox : ContainerControl
    {

        public Tokyo_GroupBox()
        {
    ...
    [DefaultEvent("CheckedChanged")]
    class Tokyo_RadioButton : Control
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!object.ReferenceEquals(_Control, this) && _Control is Tokyo_RadioButton)
                {
                    ((Tokyo_RadioButton)_Control).Checked = false;
                }
            }
        }
    ...
    class Tokyo_NotificationNumber : Control
    {
        #region Variables
        ...
        public Tokyo_NotificationNumber()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);
    ...
    class Tokyo_Listview : ListView
    {

        [DllImport("uxtheme", CharSet = CharSet.Unicode)]
        public static extern int SetWindowTheme(IntPtr hWnd, string textSubAppName, string textSubIdList);

        public Tokyo_Listview()
        {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            Tokyo_Listview.SetWindowTheme(this.Handle, "explorer", null);
            base.OnHandleCreated(e);
        }
    }
    ...
    public class Tokyo_ProgressBar : Control
    {
    ...
    class Tokyo_ProgressIndicator : Control
    {
        ...
        public Tokyo_ProgressIndicator()
        {
    ...
    class Tokyo_TabControl : TabControl
    {
        ...
        protected override void OnControlAdded(ControlEventArgs e)
        {
            ...
            if (e.Control is TabPage)
            {
                ...
                {
                    e.Control.BackColor = Color.FromArgb(240, 240, 240);
                }
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _Graphics.Clear(Color.FromArgb(240, 240, 240));
    ...
    public class Tokyo_MenuStrip : MenuStrip
    {

        public Tokyo_MenuStrip()
        {
    ...
    public class Tokyo_ContextMenuStrip : ContextMenuStrip
    {

        public Tokyo_ContextMenuStrip()
        {
            this.Renderer = new ControlRenderer();
        }
    ...
    public class Tokyo_StatusStrip : StatusStrip
    {

        public Tokyo_StatusStrip()
        {
            this.Renderer = new ControlRenderer();
            SizingGrip = false;
        }
    ...
    class Tokyo_Icon_Info : Control
    {
        public Tokyo_Icon_Info()
        {
    ...
    class Tokyo_Icon_Tick : Control
    {

        public Tokyo_Icon_Tick()
        {
            this.ForeColor = Color.DimGray;
            this.BackColor = Color.FromArgb(240, 240, 240);
            this.Size = new Size(33, 33);
